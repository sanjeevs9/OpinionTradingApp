...
function sell(userId, stockSymbol, quantity, price, stockType) {
    ...
    if (!schema_1.stock_balance[userId][stockSymbol] || !schema_1.stock_balance[userId][stockSymbol][stockType] || schema_1.stock_balance[userId][stockSymbol][stockType].quantity < quantity) {
